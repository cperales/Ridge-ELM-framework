...
elseif strcmp(kernel_type,'polynomial_kernel')
    if nargin<4,
        omega = 1/4.*(2+ (3.*(Xtrain*Xtrain')./kernel_pars(1)) - ((Xtrain*Xtrain')./kernel_pars(1)).^(3));
    else
        omega = 1/4.*(2+ (3.*Xtrain*Xt'./kernel_pars(1)) - ((Xtrain*Xt')./kernel_pars(1)).^(3));
    end
